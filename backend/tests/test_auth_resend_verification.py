...
def test_resend_for_already_verified_user_is_400(client, sent_emails):
...
def test_immediate_resend_after_register_hits_cooldown_429(client, sent_emails):
...
def test_resend_succeeds_once_cooldown_elapsed(client, sent_emails, db_session):
