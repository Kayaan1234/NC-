...
def test_valid_refresh_issues_new_access_token(client, sent_emails):
...
def test_refresh_rotates_and_old_cookie_is_revoked(client, sent_emails, db_session):
    register_and_verify(client, sent_emails)
...
def test_expired_refresh_token_returns_401(client, sent_emails, db_session):
    register_and_verify(client, sent_emails)
...
def test_stored_hash_matches_issued_token_and_raw_is_never_stored(client, sent_emails, db_session):
